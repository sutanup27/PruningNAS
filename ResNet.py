...
def ResNet18(classes=1000):  return ResNet(BasicBlock, [2, 2, 2, 2],classes)
def ResNet34(classes=1000):  return ResNet(BasicBlock, [3, 4, 6, 3],classes)
def ResNet50(classes=1000):  return ResNet(Bottleneck, [3, 4, 6, 3],classes)
def ResNet101(classes=1000): return ResNet(Bottleneck, [3, 4, 23, 3],classes)
def ResNet152(classes=1000): return ResNet(Bottleneck, [3, 8, 36, 3],classes)
